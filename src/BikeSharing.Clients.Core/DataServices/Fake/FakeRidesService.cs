...
namespace BikeSharing.Clients.Core.DataServices.Fake
{
    public class FakeRidesService : IRidesService
    {
        ...
        private static List<Trends> trends = StaticData.GetTrends();
        private static List<Usage> usage = StaticData.GetUsage();
        ...
        public FakeRidesService(IRequestProvider requestProvider, IAuthenticationService authenticationService, ILocationProvider locationProvider)
        {
        ...
        public async Task<IEnumerable<Trends>> GetTrends()
        {
            await Task.Delay(200);

            return trends;
        }
        public async Task<IEnumerable<Usage>> GetUsage()
        {
            await Task.Delay(200);
